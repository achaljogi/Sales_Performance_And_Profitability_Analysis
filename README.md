...
## Project Overview
This project analyzes sales performance and profitability using a retail superstore dataset. The goal is to identify key business drivers, profitability trends, and areas for improvement using Python-based data analysis and visualization techniques.
...
## Author
**Achal Jogi**  
M.Sc. Bioinformatics | Aspiring Data Analyst | Python | Pandas | Data Analytics 
